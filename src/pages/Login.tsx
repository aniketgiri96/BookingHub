            ...
            <div className="mb-6">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="pl-10 block w-full rounded-md border border-gray-300 bg-white text-gray-900 placeholder-gray-500 shadow-sm focus:border-blue-500 focus:ring focus:ring-blue-500 focus:ring-opacity-50 dark:bg-white dark:text-gray-900 dark:placeholder-gray-500"
